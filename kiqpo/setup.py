...
setuptools.setup(
    ...
    description="Open source WEB-UI framework",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/kiqpo/kiqpo",
    project_urls={
        "Bug Tracker": "https://github.com/kiqpo/kiqpo/issues",
        "doc": "https://kiqpo.github.io/kiqpo-dco/"
    },
    classifiers=[
    ...
    scripts=["./Kiqpo.py"],
    python_requires=">=3.6",
    keywords=["Open source","WEB-UI","framework","python","kiqpo","kiqpo","kiqpo.py"]
)
